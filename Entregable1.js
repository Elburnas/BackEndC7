class TicketManager {
    ...
    getEventsId = (idEv) => {
        ...
        if(eventos = eventos.find(eventos => eventos.id === idEv))
        {
            console.log(eventos)
            return
        }
...
ticketManager.addEvent('Chayanne', 'Concierto para madres', 400, 'http://www.coderimages.com/chayanne.jpg', '101012', 500)
...
console.log(ticketManager.getEvents())
console.log(ticketManager.getEventsId(3))
